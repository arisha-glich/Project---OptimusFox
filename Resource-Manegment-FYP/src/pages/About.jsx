      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <section>
            ...
            <p className="text-gray-600 mb-2">If you have any questions or would like to learn more about our services, please get in touch with us!</p>
            <p className="text-gray-600">Email: <a href="mailto:contact@yourcompany.com" className="text-blue-500 hover:underline">contact@yourcompany.com</a></p>
